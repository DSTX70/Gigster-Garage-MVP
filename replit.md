...
-   **Health/Version Endpoint**: Public `GET /api/health` and `GET /api/version` endpoints returning service status, version, build metadata, uptime, and timestamp. Version displayed in Settings page footer.
